  ...
  begin
    if (a = nil) then
        ...
        if (a^.dato.codigo < cod) then
            ...
            CantidadDeCodigosMenores := 0;
        CantidadDeCodigosMenores := CantidadDeCodigosMenores + CantidadDeCodigosMenores(a^.HI, cod) + CantidadDeCodigosMenores(a^.HD, cod);
    end;
  end;
  ...
  begin
    if (a = nil) then
        ...
        if (a^.dato.codigo > codigo1) and (a^.dato.codigo < codigo2) then
            ...
            ObtenerMontoTotalEntreDosCodigos := 0;
        ObtenerMontoTotalEntreDosCodigos := ObtenerMontoTotalEntreDosCodigos + ObtenerMontoTotalEntreDosCodigos(a^.HI, codigo1, codigo2) + ObtenerMontoTotalEntreDosCodigos(a^.HD, codigo1, codigo2);
    end;
  end;
