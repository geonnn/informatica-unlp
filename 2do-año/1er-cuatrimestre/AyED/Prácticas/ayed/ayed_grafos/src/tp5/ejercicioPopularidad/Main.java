...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Popularidad popUsuario = Parcial.nivelPopularidad(grafo, usuario, distancia, umbral);

        System.out.println("Popularidad de " + usuario + " (distancia <= " + distancia + ", umbral = " + umbral + "):");
        
        System.out.println(popUsuario.toString());
    }
}
