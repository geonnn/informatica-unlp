...
# if string $3 is empty
if [ -z "$3" ]; then
	echo "El string pasado como parámetro no puede estar vacío."
	exit 4
fi

# pone el dir en una pila y lo hace el current working dir.
# da como output la pila.
pushd "$1" > /dev/null
